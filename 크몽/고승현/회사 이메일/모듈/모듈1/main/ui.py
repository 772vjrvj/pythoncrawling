...
def start_app():
    ...
    keyword_label = tk.Label(input_frame, text="키워드 입력:", anchor="w")
    keyword_label.grid(row=0, column=0, padx=5)

    keyword_text = tk.Text(input_frame, height=1, width=20)
    keyword_text.grid(row=0, column=1, padx=5)

    company_count_label = tk.Label(input_frame, text="회사 갯수 입력:", anchor="w")
    company_count_label.grid(row=0, column=2, padx=5)

    company_count_text = tk.Text(input_frame, height=1, width=20)
    company_count_text.grid(row=0, column=3, padx=5)
