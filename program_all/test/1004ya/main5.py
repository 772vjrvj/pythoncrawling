...
- BUSINESS_HOUR : p-태그만 보고 '영업시간' 이후의 (오전/오후/낮/밤/새벽)+시각 토큰 2개를 최초 발견 순서로 'HH:MM ~ HH:MM'
...
- 결과 CSV(result.csv): SHOP_ID, BUSINESS_HOUR, CLOSED_DAY('연중무휴(전화문의)'), PROGRAM(JSON), SHOP_INTRO_NEW_ONE(JSON), SHOP_INTRO_NEW_TWO, SHOP_INTRO_NEW_THREE
- 멀티스레드 10개씩 동시 크롤링
"""
