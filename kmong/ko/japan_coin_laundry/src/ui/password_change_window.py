...
import requests
from src.workers.change_password_thread import ChangePasswordThread
...
class PasswordChangeWindow(QDialog):
    ...
    def change_password(self):
        ...
        # ChangePasswordThread 인스턴스 생성
        self.change_password_thread = ChangePasswordThread(session, user_id, current_password, new_password)

        # 성공 및 실패 시그널 연결
        self.change_password_thread.password_change_success.connect(self.on_password_change_success)
        self.change_password_thread.password_change_failed.connect(self.on_password_change_failed)
