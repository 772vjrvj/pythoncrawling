...
class SelectWindow(QWidget):
    ...
    def set_layout(self):
        ...
        # NETFLIX
        site_button_first = QPushButton("NETFLIX", self)
        ...
        site_button_first.clicked.connect(lambda: self.select_site("NETFLIX"))

        # COUPANG
        site_button_second = QPushButton("COUPANG", self)
        ...
        site_button_second.clicked.connect(lambda: self.select_site("COUPANG"))

        # TVING
        site_button_third = QPushButton("TVING", self)
        ...
        site_button_third.clicked.connect(lambda: self.select_site("TVING"))
