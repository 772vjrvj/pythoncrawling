...
def fetch_search_results(query, page):
    try:
        ...
        headers = {
            ...
            'Referer': '',
            'Cookie': 'NNB=KJRADCOI5CJGM; NAC=3JEFBMw72ynA; ASID=da9384ec00000190f2d1620e00000073; _fwb=19akMzMYcdS8hQZ68HE1NF.1724467531676; NACT=1; nid_inf=391275843; NID_AUT=jpIvTJ/Zgi7s1RquvhHT9qAmezkbwZrH/CQBv6+3NiS6yB8CP814baXqltTbG04i; NID_SES=; NID_JKL=IH1lXx5SwVCwa09VROMl1XMeALXBLcUAkk2wm7AkFSQ=; wcs_bt=sp_96f66d2bb884d0:1729618037|sp_37b2c86586317:1724481093|sp_1a6594ee935b78:1724481021|sp_18c879f04339ae0:1724480738|sp_7b7380f3150d68:1724475946|sp_784b17df705b08:1724475939|sp_96d5cd32bf2108:1724475931|sp_97bfe1265e4f98:1724475835|sp_97be8eb42f1d00:1724475811|sp_58107671648740:1724475781; BUC=2sd5JeL4lRC0lcA_z5d1SnRsgvZSlr6yJKi2JEnTeJ4='
        }
...
if __name__ == "__main__":
    ...
    # 파일 이름에 시간 추가
    filename = f"맛집_{current_time}.xlsx"
    for index, name in enumerate(names, start=1):
        name2 = f'{name["시도"]} {name["시군구"]} {name["읍면동"]} 맛집'
        new_print(f"Total : {len(names)}, index : {index}, name : {name2}==============================================")
        query = f"{name2}"
        rs = main(query)
        if rs:
