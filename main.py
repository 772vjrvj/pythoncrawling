...
def fetch_zipcode(id):
    ...
    payload = {
        "operationName": "GetSearchZipcodeByQuery",
        "query": "query GetSearchZipcodeByQuery($address: String!, $businessId: String!, $isNx: Boolean) {\n  searchZipCodeByQuery: searchZipCodeByQuery(\n    address: $address\n    businessId: $businessId\n    isNx: $isNx\n  ) {\n    zipCode\n    __typename\n  }\n}",
        "variables": {
            "address": "",
            "businessId": id,
            "isNx": False
    ...
    try:
        ...
        # zipcode 추출
        zipcode = data.get('data', {}).get('searchZipCodeByQuery', {}).get('zipCode', "")
        ...
        # 예상치 못한 데이터 구조일 때 에러 처리
        print("응답 데이터에서 우편번호를 찾을 수 없습니다.")
        return ""
...
def save_to_excel(results_dict, file_name):
    ...
    df_selected = df[["ID", "시도", "시군구", "읍면동", "주소", "도로명 주소", "상세주소", "이름", "카테고리", "전화번호", "URL", "Page", "검색 키워드", "검색 시도", "검색 시군구", "검색 읍면동", "우편번호"]]
        ...
        for index, entry in enumerate(cities):
            ...
            while True:
                ...
                for place in places:
                    ...
                    new_place["우편번호"] = fetch_zipcode(place.get("id"))
...
if __name__ == "__main__":
    ...
    # https://www.data.go.kr/data/15063424/fileData.do 여기서 다운 받아도 되고 open api 로 사용해도됨
    # https://www.data.go.kr/data/15029173/standard.do
    # 여기서는 내가 정리해서 사용
