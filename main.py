        ...
        if response.status_code == 200:
            ...
            if script_tag:
                ...
                if json_text:
                    ...
                    fsasReviewsTotal = ""
                    fsasReviewsTotal1 = root_query.get(place_detail_key, {}).get('fsasReviews', {}).get('fsasReviews', {}).get("total", "")
                    if fsasReviewsTotal1:
                        fsasReviewsTotal = fsasReviewsTotal1
                    else:
                    ...
                    print(f"business_hours : {business_hours}")

                    new_business_hours = root_query.get(place_detail_key, {}).get('newBusinessHours', [])

                    print(f"new_business_hours : {new_business_hours}")
...
def main(query):
    try:
        ...
        all_ids_list = ['1252605117', '1749059391']
